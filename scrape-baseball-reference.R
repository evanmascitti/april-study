# I downloaded this file from https://raw.githubusercontent.com/richjand/Scrape-Baseball-Reference/master/ScrapeBrefFunction.R on June 8 2020.

# The code will not run because it can't find the function `html()`....I suspect this 
# was removed from the rvest package at some point but not sure when.
# If I really wanted to dig into this I could probably download an old version 
# of rvest and try running it, but I don't yet see the need....however, it would be 
# useful to test my hypothesis about big innings (I actually started a separate project
# to look into that, but haven't taken any action on it yet.)
